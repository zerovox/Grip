...
(function (e, t) {
    ...
    v.fn = v.prototype = {constructor:v, init:function (e, n, r) {
        ...
        for (; a < f; a++)if ((e = arguments[a]) != null) {
            for (n in e) {
                r = u[n], i = e[n];
                if (u === i)continue;
        ...
        if (r) {
            if (u) {
                ...
                for (; s < o;)if (n.apply(e[s++], r) === !1)break
            }
        } else if (u) {
    ...
    v.event = {add:function (e, n, r, i, s) {
        ...
        function at(e, t, r) {
            ...
            return t.first ? function (t, n, r) {
                ...
                if (!u) {
                    ...
                    while (t = t[i])if (s || t.nodeType === 1)if (e(t, r, u))return t
                }
            }
        }
        ...
        function ht(e) {
            ...
            for (; a < s; a++)if (n = i.relative[e[a].type]) {
                h = [at(ft(h), n)];
            } else {
...
(function (e, t, n) {
    ...
    e.fn.foundationButtons = function (t) {
        var n = e(document), r = e.extend({dropdownAsToggle:!0, activeClass:"active"}, t), i = function (t) {
            e(".button.dropdown").find("ul").not(t).removeClass("show-dropdown")
        }, s = function (t) {
            var n = e(".button.dropdown").not(t);
            n.add(e("> span." + r.activeClass, n)).removeClass(r.activeClass)
        };
        n.on("click.fndtn", ".button.disabled", function (e) {
            e.preventDefault()
        }), e(".button.dropdown > ul", this).addClass("no-hover"), n.on("click.fndtn", ".button.dropdown:not(.split), .button.dropdown.split span", function (t) {
            var n = e(this), o = n.closest(".button.dropdown"), u = e("> ul", o);
            t.preventDefault(), i(r.dropdownAsToggle ? u : ""), u.toggleClass("show-dropdown"), r.dropdownAsToggle && (s(o), n.toggleClass(r.activeClass))
        }), n.on("click.fndtn", "body, html", function (t) {
            e(t.originalEvent.target).is(".button.dropdown:not(.split), .button.dropdown.split span") || (i(), r.dropdownAsToggle && s())
        });
        var o = e(".button.dropdown:not(.large):not(.small):not(.tiny)", this).outerHeight() - 1, u = e(".button.large.dropdown", this).outerHeight() - 1, a = e(".button.small.dropdown", this).outerHeight() - 1, f = e(".button.tiny.dropdown", this).outerHeight() - 1;
        e(".button.dropdown:not(.large):not(.small):not(.tiny) > ul", this).css("top", o), e(".button.dropdown.large > ul", this).css("top", u), e(".button.dropdown.small > ul", this).css("top", a), e(".button.dropdown.tiny > ul", this).css("top", f), e(".button.dropdown.up:not(.large):not(.small):not(.tiny) > ul", this).css("top", "auto").css("bottom", o - 2), e(".button.dropdown.up.large > ul", this).css("top", "auto").css("bottom", u - 2), e(".button.dropdown.up.small > ul", this).css("top", "auto").css("bottom", a - 2), e(".button.dropdown.up.tiny > ul", this).css("top", "auto").css("bottom", f - 2)
    }
})(jQuery, this);
(function (e, t, n) {
    "use strict";
    e.fn.foundationTabs = function (n) {
        var r = e.extend({callback:e.noop}, n), i = function (t) {
            var n = t.closest("dl, ul").find(".active"), r = t.children("a").attr("href"), i = /^#/.test(r), s = "";
        ...
        e(document).on("click.fndtn", ".tabs a", function (t) {
            i(e(this).parent("dd, li"))
        }), t.location.hash && (i(e('a[href="' + t.location.hash + '"]').parent("dd, li")), r.callback())
    }
})(jQuery, this);
/*
    ...
    var r = {version:"2.0.1", tipLocation:"bottom", nubPosition:"auto", scrollSpeed:300, timer:0, startTimerOnClick:!0, startOffset:0, nextButton:!0, tipAnimation:"fade", pauseAfter:[], tipAnimationFadeSpeed:300, cookieMonster:!1, cookieName:"joyride", cookieDomain:!1, tipContainer:"body", postRideCallback:e.noop, postStepCallback:e.noop, template:{link:'<a href="#close" class="joyride-close-tip">X</a>', timer:'<div class="joyride-timer-indicator-wrap"><span class="joyride-timer-indicator"></span></div>', tip:'<div class="joyride-tip-guide"><span class="joyride-nub"></span></div>', wrapper:'<div class="joyride-content-wrapper"></div>', button:'<a href="#" class="small button joyride-next-tip"></a>'}}, i = i || !1, s = {}, o = {init:function (n) {
        return this.each(function () {
            if (e.isEmptyObject(s)) {
                ...
                }), e(".joyride-close-tip").on("click.joyride", function (e) {
                    e.preventDefault(), o.end()
                }), s.$window.on("resize.joyride", function (e) {
        ...
        var t = s.$window, n = t.outerWidth() + t.scrollLeft(), r = t.outerWidth() + t.scrollTop();
...
(function (e, t, n) {
    "use strict";
    var r = {templates:{viewing:'<a href="#" class="clearing-close">&times;</a><div class="visible-img" style="display: none"><img src="#"><p class="clearing-caption"></p><a href="#" class="clearing-main-left"></a><a href="#" class="clearing-main-right"></a></div>'}, locked:!1}, i = {}, s = {init:function (t, n) {
        return this.find("ul[data-clearing]").each(function () {
            var t = e(document), n = e(this), i = i || {}, o = o || {}, u = n.data("fndtn.clearing.settings");
            u || (i.$parent = n.parent(), n.data("fndtn.clearing.settings", e.extend({}, r, i)), s.extend(s, o), s.assemble(n.find("li")), s.events())
        })
    }, events:function () {
        var n = e(document);
        n.on("click.fndtn.clearing", "ul[data-clearing] li", function (t, n, r) {
            var n = n || e(this), r = r || n;
            t.preventDefault(), s.open(e(t.target), n, r), s.update_paddles(r)
        ...
        }), n.on("click.fndtn.clearing", "a.clearing-close, div.clearing-blackout", function (t) {
            var n = function (e) {
            ...
            var n = e(".clearing-blackout").find("ul[data-clearing]");
            t.which === 39 && s.go(n, "next"), t.which === 37 && s.go(n, "prev")
        ...
        var n = e.parent(), r = n.data("fndtn.clearing.settings"), i = n.detach(), s = {grid:'<div class="carousel">' + this.outerHTML(i[0]) + "</div>", viewing:r.templates.viewing}, o = '<div class="clearing-assembled"><div>' + s.viewing + s.grid + "</div></div>";
        return r.$parent.append(o)
    }, open:function (e, t, n) {
...
(function (e, t, n) {
    ...
    e.fn.foundationMagellan = function (n) {
        var r = {threshold:25, activeClass:"active"}, n = e.extend({}, r, n);
        ...
        var i = e("[data-magellan-expedition]");
        i.find("[data-magellan-arrival]:first").addClass(i.attr("data-magellan-active-class") || n.activeClass), e("[data-magellan-expedition=fixed]").on("magellan.update-position", function () {
            var t = e(this);
            t.data("magellan-fixed-position", ""), t.data("magellan-top-offset", "")
        }), e("[data-magellan-expedition=fixed]").trigger("magellan.update-position"), e(t).on("resize.magellan", function () {
            e("[data-magellan-expedition=fixed]").trigger("magellan.update-position")
        }), e(t).on("scroll.magellan", function () {
            var r = e(t).scrollTop();
            e("[data-magellan-expedition=fixed]").each(function () {
                var t = e(this);
                t.data("magellan-top-offset") === "" && t.data("magellan-top-offset", t.offset().top);
                var i = r + n.threshold > t.data("magellan-top-offset");
                t.data("magellan-fixed-position") != i && (t.data("magellan-fixed-position", i), i ? t.css({position:"fixed", top:0}) : t.css({position:"", top:""}))
            })
