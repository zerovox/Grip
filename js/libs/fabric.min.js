...
JSON || (JSON = {}), function () {
...
})), fabric.Observable = {observe:function (e, t) {
    ...
    function f(e) {
        ...
        if (!n)return t;
        if (typeof n == "string") {
            n = n.replace(/;$/, "").split(";").forEach(function (e) {
                var n = e.split(":");
    ...
    var d = {has:function (e, t) {
        t(!1)
    }, get:function () {
    }, set:function () {
    }};
    n(t, {parseAttributes:u, parseElements:c, parseStyleAttribute:f, parsePointsAttribute:a, getCSSRules:h, loadSVGFromURL:v, loadSVGFromString:g, createSVGFontFacesMarkup:y})
    ...
    fabric.Gradient = fabric.util.createClass({initialize:function (e) {
        ...
        var i = n.getElementsByTagName("stop"), s, o = {}, u = {x1:n.getAttribute("x1") || 0, y1:n.getAttribute("y1") || 0, x2:n.getAttribute("x2") || "100%", y2:n.getAttribute("y2") || 0};
    ...
    fabric.StaticCanvas = function (e, t) {
    ...
    }, e(fabric.StaticCanvas.prototype, fabric.Observable), e(fabric.StaticCanvas.prototype, {backgroundColor:"rgba(0, 0, 0, 0)", backgroundImage:"", backgroundImageOpacity:1, backgroundImageStretch:!0, includeDefaultValues:!0, stateful:!0, renderOnAddition:!0, clipTo:null, controlsAboveOverlay:!1, onBeforeScaleRotate:function () {
    }, onFpsUpdate:null, _initStatic:function (e, t) {
        ...
        if (t) {
            e.save(), fabric.Group.prototype.transform.call(t, e), t.drawBorders(e).drawCorners(e), e.restore();
        } else {
        ...
        var t = {objects:this._objects.map(function (t) {
            var n;
    ...
    var e = fabric.util.object.extend, t = fabric.util.getPointer, n = fabric.util.addListener, r = fabric.util.removeListener, i = {tr:"ne-resize", br:"se-resize", bl:"sw-resize", tl:"nw-resize", ml:"w-resize", mt:"n-resize", mr:"e-resize", mb:"s-resize"}, s = fabric.util.array.min, o = fabric.util.array.max, u = Math.sqrt, a = Math.pow, f = Math.atan2, l = Math.abs, c = Math.min, h = Math.max, p = .5;
    ...
    var v = {interactive:!0, selection:!0, selectionColor:"rgba(100, 100, 255, 0.3)", selectionBorderColor:"rgba(255, 255, 255, 0.3)", selectionLineWidth:1, freeDrawingColor:"rgb(0, 0, 0)", freeDrawingLineWidth:1, hoverCursor:"move", moveCursor:"move", defaultCursor:"default", rotationCursor:"crosshair", containerClass:"canvas-container", perPixelTargetFind:!1, targetFindTolerance:0, _initInteractive:function () {
        ...
        if (this._shouldClearSelection(e)) {
            this._groupSelector = {ex:r.x, ey:r.y, top:0, left:0}, this.deactivateAllWithDispatch();
        } else {
        ...
        if (r !== null) {
            i = t(e), r.left = i.x - this._offset.left - r.ex, r.top = i.y - this._offset.top - r.ey, this.renderTop();
            ...
            if (!n) {
                ...
                this._setCursorFromEvent(e, n), n.isActive() && n.setCornersVisibility && n.setCornersVisibility(!0)
            }
        } else {
            i = t(e);
            var u = i.x, a = i.y;
        ...
        this._currentTransform = {target:n, action:r, scaleX:n.scaleX, scaleY:n.scaleY, offsetX:s.x - n.left, offsetY:s.y - n.top, ex:s.x, ey:s.y, left:n.left, top:n.top, theta:n._theta, width:n.width * n.scaleX}, this._currentTransform.original = {left:n.left, top:n.top}
        ...
        if (n) {
            n.contains(t) ? (n.removeWithUpdate(t), t.setActive(!1), n.size() === 1 && this.discardActiveGroup()) : n.addWithUpdate(t), this.fire("selection:created", {target:n, e:e}), n.setActive(!0);
        } else {
        ...
        return this._activeObject && this._activeObject.setActive(!1), this._activeObject = e, e.setActive(!0), this.renderAll(), this.fire("object:selected", {target:e, e:t}), e.fire("selected", {e:t}), this
    }, getActiveObject:function () {
    ...
    function r(e, t) {
        ...
        if (typeof i != "string") {
            if (e.type === "image") {
                fabric[fabric.util.string.capitalize(e.type)].fromObject(e, function (e) {
                    n(e, t)
                });
            } else {
            ...
            fabric.loadSVGFromURL(i, function (r) {
    ...
    t.Object = t.util.createClass({type:"object", top:0, left:0, width:0, height:0, scaleX:1, scaleY:1, flipX:!1, flipY:!1, opacity:1, angle:0, cornersize:12, transparentCorners:!0, padding:0, borderColor:"rgba(102,153,255,0.75)", cornerColor:"rgba(102,153,255,0.5)", fill:"rgb(0,0,0)", fillRule:"source-over", overlayFill:null, stroke:null, strokeWidth:1, strokeDashArray:null, borderOpacityWhenMoving:.4, borderScaleFactor:1, transformMatrix:null, selectable:!0, hasControls:!0, hasBorders:!0, hasRotatingPoint:!1, rotatingPointOffset:40, _theta:0, perPixelTargetFind:!1, includeDefaultValues:!0, stateProperties:"top left width height scaleX scaleY flipX flipY theta angle opacity cornersize fill overlayFill stroke strokeWidth strokeDashArray fillRule borderScaleFactor transformMatrix selectable".split(" "), callSuper:function (e) {
        ...
        function n(e) {
            return{tl:new t.Point(e.tl.x, e.tl.y), tr:new t.Point(e.tr.x, e.tr.y), bl:new t.Point(e.bl.x, e.bl.y), br:new t.Point(e.br.x, e.br.y)}
        }
        ...
        e.tl.corner = {tl:{x:e.tl.x - i, y:e.tl.y - r}, tr:{x:e.tl.x + r, y:e.tl.y - i}, bl:{x:e.tl.x - r, y:e.tl.y + i}, br:{x:e.tl.x + i, y:e.tl.y + r}}, e.tr.corner = {tl:{x:e.tr.x - i, y:e.tr.y - r}, tr:{x:e.tr.x + r, y:e.tr.y - i}, br:{x:e.tr.x + i, y:e.tr.y + r}, bl:{x:e.tr.x - r, y:e.tr.y + i}}, e.bl.corner = {tl:{x:e.bl.x - i, y:e.bl.y - r}, bl:{x:e.bl.x - r, y:e.bl.y + i}, br:{x:e.bl.x + i, y:e.bl.y + r}, tr:{x:e.bl.x + r, y:e.bl.y - i}}, e.br.corner = {tr:{x:e.br.x + r, y:e.br.y - i}, bl:{x:e.br.x - r, y:e.br.y + i}, br:{x:e.br.x + i, y:e.br.y + r}, tl:{x:e.br.x - i, y:e.br.y - r}}, e.ml.corner = {tl:{x:e.ml.x - i, y:e.ml.y - r}, tr:{x:e.ml.x + r, y:e.ml.y - i}, bl:{x:e.ml.x - r, y:e.ml.y + i}, br:{x:e.ml.x + i, y:e.ml.y + r}}, e.mt.corner = {tl:{x:e.mt.x - i, y:e.mt.y - r}, tr:{x:e.mt.x + r, y:e.mt.y - i}, bl:{x:e.mt.x - r, y:e.mt.y + i}, br:{x:e.mt.x + i, y:e.mt.y + r}}, e.mr.corner = {tl:{x:e.mr.x - i, y:e.mr.y - r}, tr:{x:e.mr.x + r, y:e.mr.y - i}, bl:{x:e.mr.x - r, y:e.mr.y + i}, br:{x:e.mr.x + i, y:e.mr.y + r}}, e.mb.corner = {tl:{x:e.mb.x - i, y:e.mb.y - r}, tr:{x:e.mb.x + r, y:e.mb.y - i}, bl:{x:e.mb.x - r, y:e.mb.y + i}, br:{x:e.mb.x + i, y:e.mb.y + r}}, e.mtr.corner = {tl:{x:e.mtr.x - i + s * this.rotatingPointOffset, y:e.mtr.y - r - u * this.rotatingPointOffset}, tr:{x:e.mtr.x + r + s * this.rotatingPointOffset, y:e.mtr.y - i - u * this.rotatingPointOffset}, bl:{x:e.mtr.x - r + s * this.rotatingPointOffset, y:e.mtr.y + i - u * this.rotatingPointOffset}, br:{x:e.mtr.x + i + s * this.rotatingPointOffset, y:e.mtr.y + r - u * this.rotatingPointOffset}}
    }, toGrayscale:function () {
        var e = this.get("fill");
        ...
        var i = this;
        r || (r = {}), "from"in r || (r.from = this.get(e)), /[+\-]/.test((n + "").charAt(0)) && (n = this.get(e) + parseFloat(n)), t.util.animate({startValue:r.from, endValue:n, byValue:r.by, easing:r.easing, duration:r.duration, onChange:function (t) {
    ...
    t.Line = t.util.createClass(t.Object, {type:"line", initialize:function (e, t) {
        ...
        return n(this.callSuper("toObject"), {x1:this.get("x1"), y1:this.get("y1"), x2:this.get("x2"), y2:this.get("y2")})
    }, toSVG:function () {
    ...
    t.Ellipse = t.util.createClass(t.Object, {type:"ellipse", initialize:function (e) {
    ...
    t.Rect = t.util.createClass(t.Object, {type:"rect", rx:0, ry:0, initialize:function (e) {
    ...
    t.Polyline = t.util.createClass(t.Object, {type:"polyline", initialize:function (e, t) {
    ...
    t.Polygon = t.util.createClass(t.Object, {type:"polygon", initialize:function (e, t) {
    ...
    t.PathGroup = t.util.createClass(t.Path, {type:"path-group", fill:"", forceFillOverwrite:!1, initialize:function (e, t) {
        t = t || {}, this.paths = e || [];
    ...
    if (t.Group)return;
    t.Group = t.util.createClass(t.Object, {type:"group", initialize:function (e, t) {
    ...
    fabric.Image = fabric.util.createClass(fabric.Object, {active:!1, type:"image", initialize:function (e, t) {
        ...
        return t(this.callSuper("toObject"), {src:this._originalImage.src || this._originalImage._src, filters:this.filters.concat()})
    }, toSVG:function () {
    ...
    t.Text = t.util.createClass(t.Object, {fontSize:40, fontWeight:100, fontFamily:"Times New Roman", textDecoration:"", textShadow:"", textAlign:"left", fontStyle:"", lineHeight:1.3, strokeStyle:"", strokeWidth:1, backgroundColor:"", path:null, type:"text", useNative:!0, initialize:function (e, t) {
        ...
        this.transform(e), Cufon.replaceElement(n, {engine:"canvas", separate:"none", fontFamily:this.fontFamily, fontWeight:this.fontWeight, textDecoration:this.textDecoration, textShadow:this.textShadow, textAlign:this.textAlign, fontStyle:this.fontStyle, lineHeight:this.lineHeight, strokeStyle:this.strokeStyle, strokeWidth:this.strokeWidth, backgroundColor:this.backgroundColor}), this.width = t.width, this.height = t.height, this._totalLineHeight = t.totalLineHeight, this._fontAscent = t.fontAscent, this._boundaries = t.boundaries, this._shadowOffsets = t.shadowOffsets, this._shadows = t.shadows || [], n = null, this.setCoords()
        ...
        return n(this.callSuper("toObject"), {text:this.text, fontSize:this.fontSize, fontWeight:this.fontWeight, fontFamily:this.fontFamily, fontStyle:this.fontStyle, lineHeight:this.lineHeight, textDecoration:this.textDecoration, textShadow:this.textShadow, textAlign:this.textAlign, path:this.path, strokeStyle:this.strokeStyle, strokeWidth:this.strokeWidth, backgroundColor:this.backgroundColor, useNative:this.useNative})
    }, toSVG:function () {
