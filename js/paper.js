    ...
    var PaperScript = this.PaperScript = new function () {
        var parse_js = new function () {
            ...
            function S(a, b) {
                ...
                function v(a) {
                    ...
                    return b == 0 ? "{}" : "{" + e + W(a,function (a, d) {
                        var f = a[1].length > 0, g = j(function () {
                ...
                var c = !!b.beautify, d = 0, e = c ? "\n" : "", f = c ? " " : "", r = {string:Q, num:q, name:g, toplevel:function (a) {
                    return u(a).join(e)
                }, splice:function (a) {
            ...
            function N() {
                ...
                return{walk:f, with_walkers:g, parent:function () {
                    return e[e.length - 2]
                }, stack:function () {
                    return e
                }}
